...
import {ExtractedDoc, Transaction} from "./types"
...
export class BamlAsyncClient {
  ...
  async ExtractDoc(
    ...
    try {
      ...
      return raw.parsed() as ExtractedDoc
    } catch (error: any) {
...
class BamlStreamClient {
  ...
  ExtractDoc(
      doc: Image[],
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<ExtractedDoc>, ExtractedDoc> {
    try {
      ...
      return new BamlStream<RecursivePartialNull<ExtractedDoc>, ExtractedDoc>(
        raw,
        (a): a is RecursivePartialNull<ExtractedDoc> => a,
        (a): a is ExtractedDoc => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
